...
export default function Bask(props) {
	return (
		<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path fillRule="evenodd" clipRule="evenodd"
				  ...
				  fill="#333333" stroke="#2E384C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
			<path fillRule="evenodd" clipRule="evenodd"
			...
			<path d="M14.1255 10.795H16.8985" stroke="#333333" strokeWidth="2" strokeLinecap="round"
